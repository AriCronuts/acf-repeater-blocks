...
Contributors: cronutsdigital
Tags: acf, elementor, repeater, advanced custom fields
...
= 1.2.5 =
* Fix: aumentar especificidad CSS para anular estilos hover de Elementor Kit en acordeón.

= 1.2.4 =
* Fix: neutralizar flash de estilos Elementor Kit al hacer click en acordeón.
* Fix: título del acordeón desbordaba sin salto de línea.
